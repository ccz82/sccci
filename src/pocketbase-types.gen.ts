...
export type NotesRecord<Tcontent = unknown> = {
...
export type NotesResponse<Tcontent = unknown, Texpand = unknown> = Required<NotesRecord<Tcontent>> & BaseSystemFields<Texpand>
